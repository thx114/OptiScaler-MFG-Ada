...
class DlssNr_Dx12 : public Shader_Dx12, public DlssNr_Common
{
  ...
  public:
    ...
    // Dx11wDx12SC present hand-off: bypasses the external-FG gate, picture is a real game frame.
    void ApplyFinishedBridge(ID3D12Resource* picture, ID3D12CommandQueue* queue, DXGI_COLOR_SPACE_TYPE space);
